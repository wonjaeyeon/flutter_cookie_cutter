...
class CustomTheme extends ThemeExtension<CustomTheme> {
  ...
  ThemeData _base(final ColorScheme colorScheme) {
    final primaryTextTheme = GoogleFonts.ibmPlexSansKrTextTheme();
    final secondaryTextTheme = GoogleFonts.ibmPlexSansJpTextTheme();
    final textTheme = primaryTextTheme.copyWith(
      ...
      titleLarge: secondaryTextTheme.titleLarge,
      titleMedium: secondaryTextTheme.titleMedium,
      titleSmall: secondaryTextTheme.titleSmall,
    );

    // NOTE : you can use 'apply' if you want to pick the font of your own
    // final textTheme = primaryTextTheme.apply(
    //   fontFamily: 'Pretendard',
    //   fontSizeFactor: 1.0,
    // );

    // NOTE : text theme has the priority over fontFamily parameter in ThemeData
    // NOTE : If i want to use the font family 'Pretendard' in ThemeData, i should comment('//') the textTheme parameter and uncomment the fontFamily parameter
