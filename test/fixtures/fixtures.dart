...
import 'package:flutter_cookie_cutter/data/dto/character_dto.dart';
import 'package:flutter_cookie_cutter/data/dto/location_dto.dart';

final characterDtoExample1 = CharacterDto(
  id: 1,
  name: 'Rick Sanchez',
  status: 'Alive',
  species: 'Human',
...
final characterDtoExample2 = CharacterDto(
  id: 2,
  name: 'Morty Smith',
  status: 'Alive',
  species: 'Human',
...
final characterDtoExample1Modified = CharacterDto(
  id: 1,
  name: 'Rick Sanchez Modified',
  status: 'Dead',
  species: 'Human',
  type: 'Super genius',
  gender: 'Male',
